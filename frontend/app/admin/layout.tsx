...
const adminNavItems = [
  ...
  { href: "/admin/verify", label: "Verify Claims", icon: ClipboardCheck },
  { href: "/admin/credentials", label: "Issue Credentials", icon: Award },
      ...
      >
          ...
          {adminNavItems.map((item) => {
            ...
            return (
              ...
              >
                ...
                {isActive && (
                  <motion.div layoutId="adminActiveIndicator" className="ml-auto">
        ...
        <div className="p-4 border-t border-parchment/10">
          <div className="flex items-center gap-2 px-4 py-2 rounded-lg bg-oxford-light/50">
            ...
            <span className="text-xs text-electric-cyan font-mono">Admin Access</span>
          </div>
        </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="font-heading text-2xl text-walnut">
                {adminNavItems.find((item) => pathname?.startsWith(item.href))?.label || "Admin Portal"}
              </h1>
            </div>
            <div className="flex items-center gap-4">
              <Badge variant="waxSeal">
